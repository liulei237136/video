            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <a href="{{ route('courses.videos.upload', $course->id) }}">Upload videos of course</a>
                    </div>

                    <div class="card-body">
                        @if($course->editable())
                            <form id="update-channel-form" action="{{ route('courses.update', $course->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
                                @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="text-center">
                                        <subscribe-button :channel="{{ $course }}" :initial-subscriptions="{{ $course->subscriptions }}" />
                                    </div>
                                </div>
                                ...
                                @if($course->editable())
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="name" name="name" value="{{ $course->name }}" type="text" class="form-control">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="description" rows="3" class="form-control">{{ $course->description }}</textarea>
                                    </div>
